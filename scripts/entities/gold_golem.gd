...
var chase_speed: float = 90.0
var retreat_speed: float = 120.0
var attack_range: float = 50.0
var patrol_radius: float = 300.0
var vision_range: float = 220.0
...
func _load_stats():
	if DefaultBalance:
		max_health = DefaultBalance.gold_golem_max_health
		chase_speed = DefaultBalance.gold_golem_move_speed
		patrol_speed = DefaultBalance.gold_golem_patrol_speed
		retreat_speed = DefaultBalance.gold_golem_retreat_speed
		attack_range = DefaultBalance.gold_golem_attack_range
		attack_damage = DefaultBalance.gold_golem_attack_damage
		attack_cooldown = DefaultBalance.gold_golem_attack_cooldown
		patrol_radius = DefaultBalance.gold_golem_patrol_radius
		vision_range = DefaultBalance.gold_golem_vision_range
...
func _attack():
	...
	if can_attack:
		...
		AudioManager.play_sfx("res://Audio/golem_attack.ogg", global_position, -3.0, 400.0)
...
func die():
	AudioManager.play_sfx("res://Audio/golem_death.ogg", global_position, 0.0, 300.0)
